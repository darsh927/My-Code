...
public class CombineQuickSortInsertionSort {
    ...
    public void display() {
        ...
        System.out.println("");
        System.out.println("QuickSort Run: "+count);
        System.out.println("Insertion Sort Run: "+iCount);
    ...
    public void recQuickSort(int left, int right) {
        ...
        if (size < 50) // insertion sort if small
    ...
    public static void main(String[] args) {
        ...
        {
            long n = (int) (java.lang.Math.random() * 100000);
            arr.insert(n);
        }
            arr.display();
            arr.quickSort();
